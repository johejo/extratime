...
func _main() error {
	...
	fprintf(e, "// Package extratime is an extra time package for unmarshalling and marshalling json and xml.")
	fprintf(e, "package extratime")
	fprintf(e, "// This file is auto-generated by internal/gen.go. DO NOT EDIT.")
	fprintf(e, "//go:generate go run internal/gen.go")
	if err := WriteFormattedCodeToFile(filepath.Join(repoPath, "extratime.go"), e); err != nil {
		return err
	}
